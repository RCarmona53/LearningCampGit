# Finish the method called auto_complete that accepts an Editor object and use the build_suggestion method that accepts an Array from 
# 1) Object#methods 2) Method#parameters and incorporate all of the filters explained above, making the relevant specs pass.
...
# eval isn't exactly safe. 
# Modify the Editor exercise from the last lesson to use const_get instead of eval to parse the name of the class in the second filter.
def auto_complete(editor)
    editor.cursor.read do |word|
